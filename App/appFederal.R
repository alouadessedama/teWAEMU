...
ui <- tagList(useShinyjs(),
              ...
              navbarPage("Data Processing", theme = shinytheme("flatly"),
                
                tabPanel(title = tags$div("Presentation", class = "tabname"),
                         tags$br(),
                         fluidRow(column(1),
                                  ...
                                  column(4,
                                         fluidRow(
                                           column(1),
                                           column(11,
                                                  tags$div("About the Dashboard", class ="Title1T"),
                                                  HTML("
                                          <h4 style ='font-family:garamond;color:#0000b3;'> Team: </h4>
                                          <ul>
                                          <li><strong>Rabah Arezki</strong>, UCA-CERDI-CNRS, FERDI</li>
                                          <li><strong>Alou Adess&eacute; Dama</strong>, FERDI</li>
                                          <li><strong>Gr&eacutegoire Rota-Graziosi</strong>, UCA-CERDI-CNRS</li>
                                          <li><strong>Souleymane Soumahoro</strong>, FERDI</li>
                                          <li><strong>Bruno Versailles</strong>, EC</li>
                                          ...
                                          <li><strong>Alou Adess&eacute; Dama</strong>, Ph.D in Economics from UCA-CERDI-CNRS.</li>
                                                  ...
                                                  fluidRow(align ="center",
                                                    column(1),
                                                    column(4, tags$img(src ="ec-logo-st-rvb-web_en.jpg", height = 100)),
                                                  ...
                                                  fluidRow(align ="center",
                                                    column(1),
                                                    column(3, tags$img(src ="logo_UCA.jpg", height = 100)),
                                                    column(3, tags$img(src ="logo_CERDI_UCA-01.jpg", height = 120)),
                                                    column(3, tags$img(src ="LOGO_CNRS_2019_RVB.PNG", height = 110))
                                                  ),
                                                  tags$br(),
                                                  tags$br(),
                                                  tags$div(
                ...
                tabPanel(title = tags$div("Treatment", class = "tabname"),
                         br(),
                         sidebarLayout(
